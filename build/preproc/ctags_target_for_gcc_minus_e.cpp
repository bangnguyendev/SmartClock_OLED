# 1 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"

# 3 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 4 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 5 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2

/* LIBRARY ARDUINO DEFINE  */
# 8 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 9 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 10 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 11 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 12 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
# 13 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
...
Adafruit_ST7735 tft = Adafruit_ST7735(D4, D6, D7 /* Data out*/, D5 /* Clock out*/, -1);

/* USER DEFINE  */
# 25 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 2
...
# 30 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
               (__extension__({static const char __pstr__[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "Smartclock_oled.ino" "." "30" "." "15" "\", \"aSM\", @progbits, 1 #"))) = (
# 30 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
               "Initialized"
# 30 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
               ); &__pstr__[0];}))
# 30 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
 ...
 tft.drawBitmap(0, 0, wifi, 64, 64, 0x07FF);
 tft.drawBitmap(64, 0, alarm, 64, 64, 0x07FF);
 tft.drawBitmap(0, 64, ota, 64, 64, 0x07FF);
 tft.drawBitmap(64, 64, weather, 64, 64, 0x07FF);
 delay(2000);
 tft.fillScreen(0x0000);
 testdrawtext(0, 0, "SmartClock", 2, 0xFFE0);
 ...
 testdrawtext(0, 30, "->>Found saved wifi.", 1, 0x07E0);
...
*/
# 183 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
...
*/
# 242 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
void update_FOTA()
{
 Serial.println("\n>>>>>>>>>>> Update FOTA \n");
 ...
 tft.fillScreen(0x0000);
 tft.drawBitmap(32, 0, ntp, 64, 64, 0x07FF);
 testdrawtext(5, 65, "Update OTA", 2, 0xFFE0);
 tft.setTextSize(1);
 ...
 tft.print("1.0.0");
 tft.print(" - ");
 tft.println(*((volatile uint32_t *)(0x3FF00000+(0x58))));
 ...
 while (Check_OTA)
 {
  ...
  url += "&_FirmwareInfo&k=" "225aeb30-3336-412b-906a-601c41321446" "&v=" "1.0.0" "&FirmwareInfo_&";
  ...
  case HTTP_UPDATE_FAILED:
   ...
   tft.fillRect(0, 85, 128, 128 - 85, 0x0000);
   tft.setCursor(0, 85);
   tft.setTextSize(1);
...
*/
# 347 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
void Setup_Localtime_NTP()
{
 tft.fillScreen(0x0000);
 tft.drawBitmap(32, 0, ntp, 64, 64, 0x07FF);
 testdrawtext(5, 60, "ConfigTime", 2, 0xFFE0);
 tft.setTextSize(1);
...
void Load_Local_RealTime()
{
 ...
 if ((thang == 4 /* Thang sinh nhat Bang */) && (ngay == 14 /* Ngay sinh nhat Bang */))
 {
  if (var_hpbd)
  {
   tft.fillScreen(0x0000);
   ...
   tft.drawBitmap(32, 0, hpbd, 64, 64, 0xFFE0);
   testdrawtext(5, 65, "---HPDB---", 2, 0xFFE0);
   var_hpbd = false;
  }
  else
  {
 ...
 else if (load_bitmap)
 {
  ...
  tft.drawBitmap(32, 0, ntp, 64, 64, 0x07FF);
  testdrawtext(5, 65, "-RealTime-", 2, 0xFFE0);
  load_bitmap = false;
  Serial.printf("\nload_bitmap %d \n", load_bitmap);
 }
 else
...
{
 tft.drawBitmap(32, 0, weather, 64, 64, 0x07FF);
 delay(100);
 tft.setTextSize(2);
 tft.setCursor(8, 60);
 ...
 if (WiFi.status() == WL_CONNECTED) // Check WiFi connection status
 {
  ...
  if (httpCode > 0) // check the returning code
  {
   ...
   {
    Serial.println(((reinterpret_cast<const __FlashStringHelper *>(
# 636 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
                  (__extension__({static const char __pstr__[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "Smartclock_oled.ino" "." "636" "." "16" "\", \"aSM\", @progbits, 1 #"))) = (
# 636 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
                  "Parsing failed !"
# 636 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
                  ); &__pstr__[0];}))
# 636 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
 ...
 if ((unsigned long)(millis() - time_dem_thoitiet) > 60 * 10 * 1000) // 10 phut/ lan
 {
  ...
  if (WiFi.status() == WL_CONNECTED) // Check WiFi connection status
  {
   ...
   if (httpCode > 0) // check the returning code
   {
    ...
    {
     Serial.println(((reinterpret_cast<const __FlashStringHelper *>(
# 692 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
                   (__extension__({static const char __pstr__[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "Smartclock_oled.ino" "." "692" "." "17" "\", \"aSM\", @progbits, 1 #"))) = (
# 692 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
                   "Parsing failed !"
# 692 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino" 3
                   ); &__pstr__[0];}))
# 692 "d:\\Git_NDB\\SmartClock_OLED\\Smartclock_oled\\Smartclock_oled.ino"
